...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    AudioImport("./audio/은혜_김광석선배님.mp3"),
    AudioImport("./audio/은혜_만나지못해서.mp3"),
    AudioImport("./audio/은혜_물좋아해서.mp3"),
    AudioImport("./audio/은혜_방울치는소리.mp3"),
    AudioImport("./audio/은혜_북소리.mp3"),
    AudioImport("./audio/은혜_커피가좋아서.mp3"),
    AudioImport("./audio/고요7.mp3"),
    //beach_sounds page 2 ==> 7
    AudioImport("./audio/현하_다다닥.mp3"),
    AudioImport("./audio/현하_따그륵.mp3"),
    AudioImport("./audio/현하_딱딱.mp3"),
    AudioImport("./audio/현하_메트로놈.mp3"),
    AudioImport("./audio/현하_종.mp3"),
    AudioImport("./audio/현하_툭툭.mp3"),
    ...
    var beach_sounds = {
      '은혜_김광석선배님': imports[10],
      '은혜_만나지못해서': imports[11],
      '은혜_물좋아해서': imports[12],
      '은혜_방울치는소리': imports[13],
      '은혜_북소리': imports[14],
      '은혜_커피가좋아서': imports[15],
