...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    //sounds page 1 ==> 7
    AudioImport("./audio/김도연차.mp3"),
    AudioImport("./audio/체인이민혁.mp3"),
    AudioImport("./audio/바람이민혁.mp3"),
    AudioImport("./audio/이주연친구소리.mp3"),
    AudioImport("./audio/이주연보글보글.mp3"),
    AudioImport("./audio/김도연미끄러짐.mp3"),
    AudioImport("./audio/김도연걷는소리.mp3"),
    AudioImport("./audio/쓸리는소리이민혁.mp3"),
    AudioImport("./audio/이주연데였을때내는소리.mp3"),
