...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    //sounds page 1 ==> 7
    AudioImport("./audio/김도연_걷는소리.mp3"),
    AudioImport("./audio/체인_이민혁.mp3"),
    AudioImport("./audio/이주연_친구소리.mp3"),
    AudioImport("./audio/이주연_보글보글.mp3"),
    AudioImport("./audio/이주연_데였을때내는소리.mp3"),
    AudioImport("./audio/쓸리는소리_이민혁.mp3"),
    AudioImport("./audio/바람_이민혁.mp3"),
    AudioImport("./audio/김도연_차.mp3"),
    AudioImport("./audio/김도연_미끄러짐.mp3"),
    ...
    var beach_sounds = {
      '김도연_걷는소리' : imports[8],
      '체인_이민혁' : imports[9],
      '이주연_친구소리' : imports[10],
      '이주연_보글보글' : imports[11],
      '이주연_데였을때내는소리' : imports[12],
      '쓸리는소리_이민혁' : imports[13],
      '바람_이민혁' : imports[14],
      '김도연_차' : imports[15],
      '김도연_미끄러짐' : imports[16],
      '고요10' : imports[17],
      '고요11' : imports[18],
      '고요12' : imports[19],
      '고요13' : imports[20],
    ...
    var beach_players = {
      ...
      '이주연_친구소리': [],
      '이주연_보글보글': [],
      '이주연_데였을때내는소리': [],
      '쓸리는소리_이민혁': [],
      '바람_이민혁': [],
      '김도연_차': [],
      '김도연_미끄러짐': [],
      '고요10': [],
    ...
    var beach_playcounts = {
      '김도연_걷는소리': 0,
      '체인_이민혁': 0,
      '이주연_친구소리': 0,
      '이주연_보글보글': 0,
      '이주연_데였을때내는소리': 0,
      '쓸리는소리_이민혁': 0,
      '바람_이민혁': 0,
      '김도연_차': 0,
      '김도연_미끄러짐': 0,
      '고요10': 0,
      '고요11': 0,
      '고요12': 0,
      '고요13': 0,
