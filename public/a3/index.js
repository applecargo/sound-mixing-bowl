...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    AudioImport("./audio/동민_물소리.mp3"),
    AudioImport("./audio/동민_바람.mp3"),
    AudioImport("./audio/동민_바람과트라이앵글.mp3"),
    AudioImport("./audio/동민_엔진소리.mp3"),
    AudioImport("./audio/동민_차속도소리.mp3"),
    AudioImport("./audio/동민_책정리소리.mp3"),
    AudioImport("./audio/고요7.mp3"),
    //beach_sounds page 2 ==> 7
    AudioImport("./audio/민희_바람1.mp3"),
    AudioImport("./audio/민희_바람2.mp3"),
    AudioImport("./audio/민희_벨.mp3"),
    AudioImport("./audio/민희_벨2.mp3"),
    AudioImport("./audio/민희_비행기.mp3"),
    AudioImport("./audio/민희_환풍기.mp3"),
