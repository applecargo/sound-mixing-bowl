...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    AudioImport("./audio/우주_칼림바1.mp3"),
    AudioImport("./audio/우주_칼림바2.mp3"),
    AudioImport("./audio/우주_파동-old1.mp3"),
    AudioImport("./audio/우주_파동.mp3"),
    AudioImport("./audio/고요5.mp3"),
    AudioImport("./audio/고요6.mp3"),
    AudioImport("./audio/고요7.mp3"),
    //beach_sounds page 2 ==> 7
    AudioImport("./audio/은정_노트.mp3"),
    AudioImport("./audio/은정_바람과새소리.mp3"),
    AudioImport("./audio/은정_웃음소리.mp3"),
    AudioImport("./audio/은정_웃음소리1.mp3"),
    AudioImport("./audio/은정_웃음소리2.mp3"),
    AudioImport("./audio/은정_회양목.mp3"),
    ...
    var beach_sounds = {
      '우주_칼림바1': imports[10],
      '우주_칼림바2': imports[11],
      '우주_파동-old1': imports[12],
      '우주_파동': imports[13],
      '고요5': imports[14],
      '고요6': imports[15],
      '_소리의_퍼짐______소리의_움직임_1': imports[16],
      '은정_노트': imports[17],
      '은정_바람과새소리': imports[18],
      '은정_웃음소리': imports[19],
      '은정_웃음소리1': imports[20],
      '은정_웃음소리2': imports[21],
      '은정_회양목': imports[22],
