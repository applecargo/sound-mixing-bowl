...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    AudioImport("./audio/beach/북소리.mp3"),
    AudioImport("./audio/beach/새우깡.mp3"),
    AudioImport("./audio/beach/모터.mp3"),
    AudioImport("./audio/beach/모래+카우벨.mp3"),
    AudioImport("./audio/beach/모래걸음.mp3"),
    AudioImport("./audio/beach/모래차기.mp3"),
    AudioImport("./audio/beach/상여.mp3"),
    //beach_sounds page 2 ==> 7
    AudioImport("./audio/beach/북치기02.mp3"),
    AudioImport("./audio/beach/하모니카.mp3"),
    AudioImport("./audio/beach/까마귀피리.mp3"),
    AudioImport("./audio/beach/모래차기02.mp3"),
    AudioImport("./audio/beach/사랑을했다~.mp3"),
    AudioImport("./audio/beach/모래야돌아와.mp3"),
    AudioImport("./audio/beach/와랑바랑뎅데굴.mp3"),
    //
