...
$(document).ready(function() {
  ...
  Promise.all([
    ...
    //sounds page 1 ==> 7
    AudioImport("./audio/멍_1.mp3"),
    AudioImport("./audio/멍_2.mp3"),
    AudioImport("./audio/멍_3.mp3"),
    AudioImport("./audio/멍_4.mp3"),
    AudioImport("./audio/고요5.mp3"),
    AudioImport("./audio/고요6.mp3"),
    AudioImport("./audio/고요7.mp3"),
    //sounds page 2 ==> 7
    AudioImport("./audio/공포_ON.mp3"),
    AudioImport("./audio/공포_OFF.mp3"),
    AudioImport("./audio/공포_손.mp3"),
    AudioImport("./audio/공포_공포.mp3"),
    AudioImport("./audio/공포_규칙.mp3"),
